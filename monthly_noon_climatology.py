...
def main():
    ...
    # Create dates for days 1, 10, 20 of each month for 2018-2024
    # GOES-16 operational data starts in 2018
    all_dates = []
    for year in range(2018, 2025):  # 7 years of operational data
        for month in range(1, 13):  # 12 months
            for day in [1, 5, 10, 15, 20, 25]:  # 3 days per month
    ...
    try:
        ...
        noon_final = Path("decadal_climatology_2015_2024") / "goes_east_noon_climatology.png"
